 ...
 *  Foscam IP Camera
 *
 *  Author: SmartThings/Marc Kurtz
 *  Date: 2014-02-04
 */
 metadata {
	definition (name: "Foscam IP Camera", namespace: "smartthings", author: "SmartThings") {
		capability "Actuator"
		capability "Sensor"
...
def take() {
	...
	//def path = "/videostream.asf?user=${getUsername()}&pwd=${getPassword()}&rate=0"
